...
import com.example.qrcode_magic.R
...
//    attribution
        ...
        // icon
        nativeAdView.iconView = nativeAdView.findViewById<View>(R.id.native_ad_icon)
...
// button
        nativeAdView.callToActionView = nativeAdView.findViewById<View>(R.id.native_ad_button)
...
//   headline
        nativeAdView.headlineView = nativeAdView.findViewById<View>(R.id.native_ad_headline)
        (nativeAdView.headlineView as TextView?)!!.text = nativeAd.headline

//  bodyView
        nativeAdView.bodyView = nativeAdView.findViewById<View>(R.id.native_ad_body)
...
//    advertiser name
        nativeAdView.advertiserView = nativeAdView.findViewById<View>(R.id.native_ad_advertiser)
        ...
        //   ratingbar
        nativeAdView.starRatingView = nativeAdView.findViewById<View>(R.id.native_ad_rating)
